...
module.exports = {
    ...
    deleteAllMatching:deleteValues.deleteAllMatching,
    deleteValuesOutOfRange:deleteValues.deleteValuesOutOfRange,
    ...
    enrichObjSelData:changeObjects.enrichObjSelData,
    populateListOfObj:changeObjects.populateListOfObj,
    ...
    addNoiseToArray:arrayManuplation.addNoiseToArray,
    fillArrayToRange:arrayManuplation.fillArrayToRange,
    ...
    createArrFromObjCount:arrayCreation.createArrFromObjCount,
    ...
    toFixedNum:mathPractical.toFixedNum,
